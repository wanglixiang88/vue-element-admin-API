...
namespace ToolLibrary.Helper.Helper
{
    ...
    public class CommonHelper
    {
        ...
        public static double Chu(double son, double mother)
        {
            if (mother == 0)
            {
                return 0;
            ...
            {
                return Math.Round(son / mother, 4);
            }
        }
        ...
        public static string HmacSha256String(string message, string secret)
        {
            secret = secret ?? "";
        ...
        /// <returns></returns>
        public static string UrlEncodeUpper(string param)
        {
            var encode = HttpUtility.UrlEncode(param);
            if (param == encode)
            {
                return param;
            }
